package sm.cli.rpg.domain.world;

import sm.cli.rpg.common.util.MapStringBuilder;
import sm.cli.rpg.domain.character.Ally;
import sm.cli.rpg.domain.character.Enemy;
...
import static sm.cli.rpg.common.util.NumberUtils.isNotBetweenZeroAndMaxExclusive;
import static sm.cli.rpg.common.util.NumberUtils.randomIntExclusive;
