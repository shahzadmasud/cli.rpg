package sm.cli.rpg.common.generator;

import sm.cli.rpg.adapters.util.io.ExternalIO;
...
import static sm.cli.rpg.domain.builder.AsciiArtBuilder.ASCII_ART_FOLDER;
