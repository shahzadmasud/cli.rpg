...
import sm.cli.rpg.domain.exception.Victory;
...
import static sm.cli.rpg.domain.game.StaticMessages.CREDITS;
import static sm.cli.rpg.domain.game.StaticMessages.GAME_LOADED;
import static sm.cli.rpg.domain.game.StaticMessages.INTRODUCTION;
import static sm.cli.rpg.domain.game.StaticMessages.REALM_QUESTION;
import static sm.cli.rpg.domain.game.StaticMessages.greeting;
import static sm.cli.rpg.domain.game.StaticMessages.questionsToPlayer;
import static sm.cli.rpg.domain.game.StaticMessages.realmConfigDone;
